...
void http_send_error_response(int fd, int error_number) {
  http_start_response(fd, error_number);
  ...
  switch (error_number) {
    ...
    case 404:
      ...
      break;
    case 500:
      http_send_string(fd, "<h1>500 Internal Server Error</h1>");
      break;
    case 502:
      http_send_string(fd, "<h1>502 Bad Gateway</h1>");
      break;
    default:
      http_send_string(fd, "<h1>An Error Occurred</h1>");
  }
}
